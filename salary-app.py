...
st.write("""
# Adult Census Income Prediction App

This app predicts a class of **Salary** of a person!
...
st.sidebar.markdown("""
[Example CSV input file](https://github.com/supradeepdanturti/Census-Income-Prediction/blob/main/Database/sample.csv)
""")
...
# Combines user input features with entire adult dataset
# This will be useful for the encoding phase
salary_raw = pd.read_csv('https://github.com/supradeepdanturti/Salary_pred/blob/main/adult.csv?raw=true')
